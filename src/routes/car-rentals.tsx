    ...
    <>
      <section className="relative overflow-hidden">
        ...
        <div className="container-x py-16 md:py-20 text-cream">
          ...
          <h1 className="mt-3 font-display text-4xl md:text-5xl">
            Car Rental in Mumbai & Ahmedabad
          </h1>
      ...
      <section className="py-16">
        <div className="container-x grid gap-10 lg:grid-cols-[1.1fr_1fr]">
          <div>
            <SectionHeader eyebrow="Car Rentals" title="Rent a car with driver, without surprises" />
            <div className="mt-5 space-y-4 text-muted-foreground leading-relaxed">
              <p>
                ...
                dependable chauffeur-driven car rental across Mumbai and Ahmedabad.
              </p>
              <p>
      ...
      <section className="bg-muted/50 py-16">
        <div className="container-x">
          <SectionHeader eyebrow="FAQs" title="Car rental — common questions" />
          <div className="mt-8"><FAQList items={faqs} /></div>
        </div>
      </section>

      <CtaBand title="Need a car rental today?" />
    </>
  );
}
